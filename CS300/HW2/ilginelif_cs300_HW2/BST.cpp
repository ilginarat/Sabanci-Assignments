...
void BinaryNode<Comparable>::suitable(bool x)  // no need since ifSuitable is a public variable
{
    ifSuitable=x;
}
...
remove( Comparable & x, BinaryNode<Comparable> * & t ) const   //ifSuitable ı nasıl ekleyebilirim??
{
    if( t == NULL )
